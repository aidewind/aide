...
<form method="post">
  ...
  <label for="image_url">ticket Image URL</label>
  ...
  <?php } ?>
  <input type="submit" name="submit" value="Save ticket" />
</form>
<script type="text/javascript">
  function preview() {
    window.open('<?php echo $this->route_url('preview', 'ticket', $model['id']); ?>', '_blank');
  }
</script>
  ...
  <div class="row">
    <div class="col-md-4 col-sm-6">
      <div class="well"> 
        ...
        <form method="post">
          <!--<label for="site_name">Account Name</label>
          ...
          <span class="input-group-btn"><button class="btn btn-lg btn-primary" type="submit" name="submit">Save Account Information</button></span>
        </form>
      </div>
    </div>
  </div>
